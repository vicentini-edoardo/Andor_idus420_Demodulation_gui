...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.live_panel.exposure_changed.connect(self.camera_panel.set_exposure)
        self.live_panel.exposure_changed.connect(self.demod_panel.set_exposure)
        self.demod_panel.exposure_changed.connect(self.camera_panel.set_exposure)
        self.demod_panel.exposure_changed.connect(self.live_panel.set_exposure)
        self.live_panel.trigger_changed.connect(self.demod_panel.set_trigger_frequency)
        self.demod_panel.trigger_changed.connect(self.live_panel.set_trigger_frequency)
